<aside class="fixed left-0 top-0 h-full w-[280px] bg-primary dark:bg-primary-container flex flex-col py-md shadow-[0px_4px_20px_rgba(78,52,46,0.08)] z-50">
    ...
    <nav class="flex-1 space-y-1 px-sm overflow-y-auto custom-scrollbar">
        <a class="flex items-center gap-3 px-4 py-3 rounded-lg text-on-primary/70 hover:text-on-primary hover:bg-on-primary-container/5 transition-colors group" href="#">
        ...
        <a class="flex items-center gap-3 px-4 py-3 rounded-lg text-secondary-fixed font-bold border-l-4 border-secondary-fixed bg-on-primary-container/10 transition-all" href="#">
