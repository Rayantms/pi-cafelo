<x-app-layout titulo="Editar Produto">
    <div class="space-y-8">
        <section class="overflow-hidden rounded-3xl bg-gradient-to-br from-[#2a1b17] via-[#4e342e] to-[#7d562d] p-8 text-white shadow-[0_24px_80px_rgba(42,27,23,0.18)]">
            <div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                <div class="max-w-2xl">
                    <p class="text-xs uppercase tracking-[0.35em] text-[#f2ddcf]">Edição de Produtos</p>
                    <h1 class="mt-3 text-3xl font-bold lg:text-4xl">Editar produto</h1>
                    <p class="mt-3 text-sm leading-6 text-white/75">
                        Atualize os dados do produto {{ $produto->nome }} sem perder o padrão visual do sistema.
                    </p>
                </div>
        ...
        <section class="grid gap-6 xl:grid-cols-[1.25fr_0.75fr]">
            <div class="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
                <div class="mb-6">
                    ...
                    <p class="mt-2 text-sm text-slate-500">Altere os campos desejados e salve a atualização no banco.</p>
                </div>
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <input
                                ...
                                type="number"
                                min="0"
                                value="{{ old('pontos_compra', $produto->pontos_compra) }}"
                                class="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-[#d4a373] focus:ring-2 focus:ring-[#d4a373]/20"
                            />
                        </div>
                        ...
                        <div class="space-y-2 md:col-span-2">
                            ...
                            <input
                                ...
                                type="number"
                                min="0"
                                value="{{ old('pontos_resgate', $produto->pontos_resgate) }}"
                                class="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-[#d4a373] focus:ring-2 focus:ring-[#d4a373]/20"
                            />
                        </div>
                    </div>
            ...
            <aside class="space-y-6">
                <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                    <h3 class="text-lg font-semibold text-slate-900">Produto atual</h3>
                    ...
                    <div class="mt-5 space-y-3">
                        ...
                        <div class="rounded-2xl bg-[#faedcd] px-4 py-3 text-[#7d562d]">
                            <p class="text-xs uppercase tracking-[0.2em] text-[#9c6c4a]">Preço atual</p>
                ...
                <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                    <div class="flex items-center gap-3 text-slate-900">
                        <span class="material-symbols-outlined text-2xl text-amber-600">edit</span>
                        <h3 class="text-lg font-semibold">Fluxo</h3>
                    </div>

                    <ol class="mt-4 space-y-3 text-sm text-slate-600">
                        <li class="rounded-2xl bg-slate-50 px-4 py-3">1. Ajuste os campos necessários.</li>
                        <li class="rounded-2xl bg-slate-50 px-4 py-3">2. Envie o formulário para o controller.</li>
                        <li class="rounded-2xl bg-slate-50 px-4 py-3">3. O registro é atualizado na tabela <strong class="font-semibold text-slate-900">produtos</strong>.</li>
                    </ol>
                </div>
            </aside>
        </section>
